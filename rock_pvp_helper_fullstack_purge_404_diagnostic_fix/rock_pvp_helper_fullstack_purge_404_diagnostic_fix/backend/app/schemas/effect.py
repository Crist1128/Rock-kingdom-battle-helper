...
class BattleEffectSnapshotOut(ORMBase):
    """状态快照详情输出。"""

    snapshot_id: str
    battle_id: str
    turn_number: int
    active_effect_instance_ids_json: str
    self_active_elf_id: str | None = None
    enemy_active_elf_id: str | None = None
    self_elf_effect_ids_json: str | None = None
    enemy_elf_effect_ids_json: str | None = None
    self_side_effect_ids_json: str | None = None
    enemy_side_effect_ids_json: str | None = None
    field_effect_ids_json: str | None = None
    skill_slot_effect_ids_json: str | None = None
    turn_effect_ids_json: str | None = None
    full_snapshot_json: str | None = None
