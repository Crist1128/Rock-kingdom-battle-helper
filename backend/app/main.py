...
def create_app() -> FastAPI:
    ...
    def maybe_start_rocom_auto_update() -> None:
        ...
        start_rocom_update_thread(
            RocomUpdateParams(
                commit=settings.rocom_auto_update_commit,
                force=settings.rocom_auto_update_force,
                limit=settings.rocom_auto_update_limit,
                delay=settings.rocom_update_delay,
                with_images=settings.rocom_auto_update_with_images,
